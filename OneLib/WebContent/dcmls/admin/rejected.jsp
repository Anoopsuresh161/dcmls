        ...
        <ul>
          ...
          <li class="drop-down"><a href="">Manage Books</a>
            <ul>
              ...
              <li><a href="../newbookreqest/bookrequest.jsp">New Book Requests</a></li>
            </ul>
          </li>
					...
					<table>
						...
						<%for(UserDTO user:users)
					         {%>
								<tr>
								<td class="column1">
					        <input type="submit" value="Approve" name="submit" onClick="Javascript:window.location.href = 'granduser.jsp?userid=<%=user.getUserID() %>';">  
					        </td>
									<td class="column2"><%=user.getUserID() %></td>
									<td class="column3"><%=user.getUserName() %></td>
									<td class="column4"><%=user.getPhoneNumber() %></td>
									<td class="column5"><%=user.getEmailID() %></td>
									<td class="column6"><%=user.getAddress() %></td>
									<td class="column7"><%=user.getType() %></td>
								</tr>
								<%}
					          }
					          else
