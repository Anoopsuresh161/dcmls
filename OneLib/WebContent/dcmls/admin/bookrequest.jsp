      ...
      <div class="limiter">
		<div class="container-table100">
			<div class="wrap-table100">
				...
				ArrayList<BookRequestDTO> bookrequestuser=BookRequestBL.viewRequests();
					...
					<table>
						<thead>
							<tr class="table100-head">
								<td class="column1">BOOK NAME</td>
								<td class="column2">AUTHOR NAME</td>
								<td class="column3">PUBLISHER  </td>
...
{%>
								<tr>
								 <td class="column1"><%=bookrequest.getBookname()%></td>
								 <td class="column2"><%=bookrequest.getAuthor()%></td>
								 <td class="column3"><%=bookrequest.getPublisher()%></td>
								</tr>
								<%}
					          }
					          else
