					...
					<table>
						<thead>
							<tr class="table100-head">
								<th class="column1">Approve</th>
								<th class="column2">Reject</th>
								<th class="column3">UserId</th>
						...
						<%for(UserDTO user:users)
					         {%>
								<tr>
								<td class="column1">
								<input type="submit" value="Approve" name="submit" onClick="Javascript:window.location.href = 'email.jsp?userid=<%=user.getUserID() %>';">  
					 			</td>
					        	<td class="column2">
					            <input type="submit" value="Reject" name="submit" onClick="Javascript:window.location.href = 'rejectedusers.jsp?userid=<%=user.getUserID() %>';">  
					        	</td>
									<td class="column3"><%=user.getUserID() %></td>
									<td class="column4"><%=user.getUserName() %></td>
									<td class="column5"><%=user.getPhoneNumber() %></td>
									<td class="column6"><%=user.getEmailID() %></td>
									<td class="column7"><%=user.getAddress() %></td>
									<td class="column8"><%=user.getType() %></td>
								</tr>
								<%}
					          }
					          else
