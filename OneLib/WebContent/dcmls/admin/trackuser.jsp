      ...
      <div class="limiter">
		<div class="container-table100">
			<div class="wrap-table100">
				<div class="table100">
			<% 
				ArrayList<Login> logins=LoginBL.getLogins();
					...
					<table>
						<thead>
							<tr class="table100-head">
								...
								<th class="column2">Start Time</th>
								<th class="column3">End Time</th>
						...
						<%for(Login login:logins)
					         {%>
								<tr>
									<td class="column1"><%=login.getUsername()%></td>
									<td class="column2"><%=login.getIntime()%></td>
									<td class="column3"><%=login.getOuttime() %></td>
								</tr>
								<%}
					          }
					          else
