...
<script>    
    function validate()
{
	var id=document.form1.txtUserID.value;
	var name=document.form1.txtUserName.value;
	var author=document.insert.txtauthorname.value;
	var category=document.insert.txtbookcategory.value;
	var price=document.insert.txtbookprice.value;
	var valid = true;
	if (id==null || id==""){  
		document.getElementById("idloc").innerHTML="Id Cannot Be empty";   
		valid = false;
	}
	if(!isNaN(name))
	{
	...
	if(!isNaN(author))
	{
		document.getElementById("author1").innerHTML="Authorname cannot be number"; 
		valid = false;
	}
	
	if (author==null || author==""){  
		document.getElementById("author").innerHTML="author name cannot be null";
		valid = false; 
		}
	if(!isNaN(category))
	{
		document.getElementById("category1").innerHTML="Categoryname cannot be number"; 
		valid = false;
	}
	
	if (category==null || category==""){  
		document.getElementById("category").innerHTML="category cannot be null"; 
		valid = false; 
		}
	...
	if (price==null || price==""){  
		document.getElementById("price").innerHTML="cannot be null";  
		valid = false;
		}
	 return valid;  
	}
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="../login/home.jsp">OneLib</a></div>

          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                <li><a href="../login/home.jsp" class="nav-link">Home</a></li>
              </ul>
            </nav>
          </div>
        </div>
      ...
      <div class="slide-1" style="background-image: url('../../images/bg_1.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center">
            ...
            <p class="mb-5">Enter the required credentials and submit to become a registered user</p>
                  <form name="form1" method="post" onsubmit="return validate()" action="user_add_process.jsp" data-aos="fade">  
              <div class="form-group row">
              <div class="col-md-6">
                <h5>Enter valid Id</h5>
                  <input type="text" name="txtUserID" class="form-control" placeholder="Adhar/votersId">
                  <font color="red"><span id="idloc"></span></font>
                </div>
                ...
                <div class="col-md-6 mb-3 mb-lg-0">
                <h5>Email Id</h5>
                  <input type="text" name="txtEmailID" class="form-control">
                </div>
                <div class="col-md-6">
                <h5>Phone Number</h5>
